...
limitawal = 9999999 //Bebas Ganti Limit
memberlimit = 1
cr = '*K4YOU~BOTZ*' 

/******** OWNER NUMBER**********/
const ownerNumber = ["6285284051385@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["6285284051385@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
...
client.version = [2, 2119, 6]
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('Gusti','white'),color('X','lime'),color('GUSTI BOTZ','white'))
})

client.on('credentials-updated', () => {
	const authInfo = client.base64EncodedAuthInfo()
   console.log(`credentials updated!`)
   fs.writeFileSync('./RanddyMJR', JSON.stringify(authInfo, null, '\t'))
})
fs.existsSync('./RanddyMJR.json') && client.loadAuthInfo('./GustiTzy.json')
client.connect();
...
if (isBanned) return reply('```Lu kebanned kontol```')
		...
		case 'darkneon':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig instagram.com/gustinx7*', quoted: mek})
         break
         case 'wanted':
	if (!isRegistered) return reply( ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
...
caption: teks, contextInfo: {
  ...
  break
		...
		case 'request':
					...
					client.sendMessage('6285706666337@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6289666262976@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6289666262976@s.whatsapp.net', options, text, {quoted: mek})
...
case 'simi': 
       ...
       if (budy.includes(`@6295335902040`)) {
                  ...
                  reply(`Iyaa? Knpa Tag  Ada Yg bisa Saya Bantu?`)
       ...
       if (budy.includes(`GUSTI`)) {

                  reply(`Jangan Panggil Gusti Kak, Dia Lagi Sibuk.`)
